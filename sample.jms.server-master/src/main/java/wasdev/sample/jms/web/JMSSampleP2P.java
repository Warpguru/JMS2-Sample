...
public class JMSSampleP2P extends HttpServlet {
	...
	public void sendAndReceive(HttpServletRequest request,
		...
		PrintWriter out = response.getWriter();
		out.println("JMS Sample - Server: SendAndReceive Started");
		...
		Message msg = jmsContext.createTextMessage("JMS Server: Liberty Sample Message");
	...
	public void sendMessage(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		PrintWriter out = response.getWriter();
		out.println("JMS Sample - Server: SendMessage Started");
	...
	public void receiveAllMessages(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		PrintWriter out = response.getWriter();
		out.println("JMS Sample - Server: ReceiveAllMessages Started");
	...
	public void receiveAllMessagesSelectors(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		PrintWriter out = response.getWriter();
		out.println("JMS Sample - Server: ReceiveAllMessagesSelectors Started");
	...
	public void mdbRequestResponse(HttpServletRequest request,
			HttpServletResponse response) throws Exception {
		PrintWriter out = response.getWriter();
		out.println("JMS Sample - Server: MDBRequestResponse Started");
		...
		Message msg = jmsContext.createTextMessage("JMS Server: MDB Test - Message to MDB");
		msg.setJMSCorrelationID(UUID.randomUUID().toString());
		msg.setStringProperty("COLOR", "BLUE");
		JMSProducer producer = jmsContext.createProducer();
		producer.send(queue, msg);
